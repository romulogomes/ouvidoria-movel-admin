(function () {
    ...
    function AuthenticationService($http, $cookies, $rootScope, $timeout, UserService, $q) {
        ...
        function SetCredentials(iduser, username, nivel, password, callback) {
            ...
            cookieExp.setDate(cookieExp.getTime() + 20 * 60000);
        ...
        function ClearCredentials() {
            $rootScope.globals = {};
            // sessionStorage.setItem('omAdmin', '');
        ...
        function entrar(usuario) {
            ...
            //     if (usuario.email == 'admin@gmail.com' && usuario.senha == '123456') {
            //         sessionStorage.setItem('omAdmin', usuario.email);
            //         return true;
            //     } else {
            //         return false;
            //     }
